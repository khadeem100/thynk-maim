...
export async function generateMetadata({ params }): Promise<Metadata> {
  ...
  const fallbackMetaData = {
    title: 'Shared Conversation | Tynk Tech',
    description: 'Replay this Agent conversation on Tynk Tech',
    alternates: {
  ...
  try {
    ...
    const title = projectData.name || 'Shared Conversation | Tynk Tech';
    const description =
      projectData.description ||
      'Replay this Agent conversation on Tynk Tech';
