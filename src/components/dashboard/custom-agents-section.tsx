...
import { useTynkTechTeamTemplates, useInstallTemplate } from '@/hooks/react-query/secure-mcp/use-secure-mcp';
...
export function CustomAgentsSection({ onAgentSelect }: CustomAgentsSectionProps) {
  ...
  const { data: templates, isLoading, error } = useTynkTechTeamTemplates();
