        ...
        <div className="relative">
          <AlertDialogHeader className="p-6 pb-4">
            <div className='h-32 w-full rounded-xl bg-muted/50 border flex items-center justify-center'>
                <TynkTechLogo size={60} />
            </div>
            <div className="flex items-center gap-4 mt-4">
              <div>
                <AlertDialogTitle className="text-xl font-semibold">
                  Welcome to Tynk Tech
                </AlertDialogTitle>
              </div>
            </div>
            <AlertDialogDescription>
            Would you like a quick guided tour to help you get started? We'll show you the key features and how to make the most of the Tynk Tech Platform.
            </AlertDialogDescription>
          </AlertDialogHeader>
