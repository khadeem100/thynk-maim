  ...
  const items = [
    {
      ...
      title: 'Veilige en betrouwbare oplossingen',
      description: 'Wij leveren veilige digitale oplossingen met volledige controle over jouw data. Jouw systemen draaien op betrouwbare infrastructuren.',
      showGitHubInfo: true,
    },
    {
      id: 2,
      ...
      description: 'Geavanceerde cybersecurity-expertise: van volledige beveiligingsscans tot het opzetten van complete security-infrastructuren.',
      showFeatures: true,
    },
  ];
        ...
        <div className="max-w-6xl mx-auto border-l border-r border-border">
          ...
          <SectionHeader>
            ...
            <p className="text-muted-foreground text-center text-balance font-medium">
              Wij leveren veilige, schaalbare digitale oplossingen met volledige controle over jouw data en workflows.
            </p>
          </SectionHeader>
              ...
              {item.showFeatures && (
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <h4 className="font-medium">Veilige Opslag</h4>
                      <p className="text-muted-foreground text-sm">
                        100% controle over jouw data
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <h4 className="font-medium">Ondersteuning</h4>
                      <p className="text-muted-foreground text-sm">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <h4 className="font-medium">Op Maat</h4>
                      <p className="text-muted-foreground text-sm">
                        Oplossingen op maat gemaakt
                      </p>
                    </div>
                  </div>
                </div>
